...
jQuery.fn.dataTable.Api.register('MakeCellsEditable()', function (settings) {
    ...
    // Destroy
    if (settings === "destroy") {
        $(table.body()).off(settings.eventClick, "td");
        table = null;
    }

    if (table != null) {
        // On cell dblclick
        $(table.body()).on(settings.eventClick, 'td', function () {
...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    var placeholder = 'Enter data now...', confirmText = 'Confirm', cancelText = 'Cancel';
    ...
    if (settings.confirmationButton) {
        ...
        confirmText = settings.confirmationButton.confirmText ? settings.confirmationButton.confirmText : confirmText;
        confirmCss = settings.confirmationButton.confirmCss;
        cancelText = settings.confirmationButton.cancelText ? settings.confirmationButton.cancelText : cancelText;
    ...
    switch (inputType) {
        ...
        case "list-confirm": // List w/ confirm
            ...
            input.html = input.html + "</select>&nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this);'>" + confirmText + "</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>" + cancelText + "</a>" + endWrapperHtml;
            input.focus = false;
            break;
        ...
        case "datepicker-confirm":
            ...
            input.html = startWrapperHtml + "<input id='ejbeatycelledit' type='text' name='date' class='datepick " + inputCss + "'   value='" + oldValue + "'></input> &nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>" + confirmText + "</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>" + cancelText + "</a>" + endWrapperHtml;
        ...
        case "text-confirm": // text input w/ confirm
            input.html = startWrapperHtml + "<input id='ejbeatycelledit' class='" + inputCss + "' placeholder='" + placeholder + "' value='" + oldValue + "'" + (listenToKeys ? " onkeyup='if(event.keyCode==13) {$(this).updateEditableCell(this);} else if (event.keyCode===27) {$(this).cancelEditableCell(this);}'" : "") + "></input>&nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>" + confirmText + "</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>" + cancelText + "</a>" + endWrapperHtml;
            break;
        ...
        case "textarea-confirm":
            input.html = startWrapperHtml + "<textarea id='ejbeatycelledit' class='" + inputCss + "'>" + oldValue + "</textarea><a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>" + confirmText + "</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>" + cancelText + "</a>" + endWrapperHtml;
            break;
        case "number-confirm":
            ...
            break;
        default: // text input
            input.html = startWrapperHtml + "<input id='ejbeatycelledit' class='" + inputCss + "' onfocusout='$(this).updateEditableCell(this)' placeholder='" + placeholder + "' value='" + oldValue + "'></input>" + endWrapperHtml;
            break;
    }
    return input;
}
